...
// #define HWVERSION_2_3               // Run 4 and above with custom board with version 2.2 on the label
 ...
 int Default_WCB_Quantity = 3;          
  ...
  String DEFAULT_ESPNOWPASSWORD = "ESPNOW_DEMO";
  ...
  const uint8_t umac_oct2 = 0x28;     // unique MAC address for the 2nd Octet
  const uint8_t umac_oct3 = 0x55;     // unique MAC address for the 3rd Octet
