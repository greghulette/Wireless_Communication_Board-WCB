...
// WCB patch: graceful vocalizer stop. See StopEmoteGraceful() in hcr.h for why
// this sends PSG bare while StopEmote() chains QT onto PSV.
void HCRVocalizer::StopEmoteGraceful(void) {
    String msg = "PSG";
    sendCommand(msg);
}
