...
void printCommandHelp(const String &cmd) {
    ...
    // ================================================================
        ...
        Serial.println(F("    getPosition,<ch>       query position    (Maestro replies)"));
        Serial.println(F("    getMovingState         query moving flag (Maestro replies)"));
        Serial.println(F("    getErrors              query+clear errors(Maestro replies)"));
