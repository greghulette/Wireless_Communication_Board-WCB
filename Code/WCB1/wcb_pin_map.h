...
#define ONBOARD_LED         19 //  // Not Used in this board but there to match the Version 1.0 board's onboard Green LED
#define STATUS_LED_PIN      22 //  // ESP32 Status NeoPixel Pin
