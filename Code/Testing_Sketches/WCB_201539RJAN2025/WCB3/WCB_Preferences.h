...
//////////////////////////////////////////////////////////////////////
  ...
  // #define MAESTRO_ENABLED                            // Comment this out if not using the Maestro Servo Controller
    ...
    #define MESTRO_CONTROLLER_POLOLU_LIBRARY_LOCAL
    ...
    uint8_t localMaestroID = 0x03;                  // The Maestro ID that is connected to the local WCB
  #endif
  ...
  String DEFAULT_ESPNOWPASSWORD = "ESPNOW_chrislizyness";
  ...
  #ifdef MESTRO_CONTROLLER_POLOLU_LIBRARY_LOCAL           // Checks to see if you are recieving commands from the Pololu Library 
  ...
  #define CHAIN_DEFAULT_BAUD_RATE 57692            //Should be lower than 57600, I'd recommend 9600 or lower for best reliability
  ...
  const uint8_t umac_oct2 = 0x32;     // unique MAC address for the 2nd Octet
